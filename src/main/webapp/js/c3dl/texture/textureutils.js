...
c3dl.hasCorrectDimensions = function (texture)
{
  ...
  {
	c3dl.debug.logError('Texture ' + texture.src + ' is too small.' + 'Dimensions are: ' +
  ...
  {
    c3dl.debug.logError('Texture ' + texture.src + ' must have a width and height of a power of 2.' + 
